...
//PUT
  ...
  //DELETE
  peticionDelete = () => {
    axios.delete(url + '/' + fieldId + '/' + this.state.form.usu_id)
    .then(response => {
      this.modalEliminar();
      this.peticionGet();
    }).catch(err => {
        ...
        <br /><br />
          ...
          <Modal isOpen={this.state.modalInsertar}>
            ...
            <ModalBody>
              ...
              <input className="form-control" type="text" name="usu_id" readOnly onChange={this.handleChange} value = {form?form.usu_id:this.state.data.length+1}></input><br />
